...
# Add src/agents and src/scrapers to sys.path to allow simple imports
sys.path.insert(0, str(AGENT_DIR / "src" / "agents"))
sys.path.insert(0, str(AGENT_DIR / "src" / "scrapers"))
...
DEFAULT_AGENTS = {
    "resume_auditor": {"name": "Resume Auditor", "description": "Audits the LaTeX resume for syntax errors, chronological gaps, and content consistency.", "script": "src/agents/resume_auditor.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "resume_fixer": {"name": "Resume Fixer", "description": "Applies auditor recommendations to the LaTeX source and compiles a new PDF.", "script": "src/agents/resume_fixer.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "resume_customizer": {"name": "Resume Customizer", "description": "Modifies resume sections dynamically via natural language prompts.", "script": "src/agents/resume_agent.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "jd_analyzer": {"name": "JD Analyzer", "description": "Extracts skills, responsibilities, suitability score, and interview prep questions from JDs.", "script": "src/agents/jd_analyzer.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "cover_letter_generator": {"name": "Cover Letter Gen", "description": "Generates a highly personalized, role-specific cover letter draft.", "script": "src/agents/cover_letter_generator.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "skill_gap_agent": {"name": "Skill Gap Agent", "description": "Formulates a weekly learning checklist and study path to fill technical gaps.", "script": "src/agents/skill_gap_agent.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "orchestrator": {"name": "Master Orchestrator", "description": "Sequences JD Analysis, Cover Letter Drafting, and Skill Gap Roadmap generation.", "script": "src/agents/orchestrator.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "job_scraper": {"name": "Job Scraper", "description": "Monitors ATS boards and scrapes job postings, matching them against candidate profiles.", "script": "src/scrapers/job_scraper.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "agency_scraper": {"name": "Agency Scraper", "description": "Discovers staffing and recruitment consultancies in target locations.", "script": "src/scrapers/agency_scraper.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "job_agent": {"name": "Cold Outreach Agent", "description": "Generates and sends personalized cold outreach emails with resumes attached.", "script": "src/agents/job_agent.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0},
    "mock_interviewer": {"name": "Mock Interviewer", "description": "Simulates conversational turn-based technical screening interviews.", "script": "src/agents/mock_interview_agent.py", "status": "idle", "last_run_status": "", "last_run_timestamp": "", "run_count": 0, "avg_latency_sec": 0.0}
}
...
class DashboardHandler(BaseHTTPRequestHandler):
    ...
    def handle_jobs_scrape(self):
        ...
        try:
            ...
            DashboardHandler.scraper_process = subprocess.Popen(
                [sys.executable, str(AGENT_DIR / "src" / "scrapers" / "job_scraper.py")],
                stdout=log_file,
                stderr=log_file,
                cwd=str(AGENT_DIR)
            )
    ...
    def handle_resume_audit(self):
        ...
        try:
            ...
            DashboardHandler.auditor_process = subprocess.Popen(
                [sys.executable, str(AGENT_DIR / "src" / "agents" / "resume_auditor.py"), "--goal", goal],
                stdout=log_file,
                stderr=log_file,
                cwd=str(AGENT_DIR)
            )
    ...
    def handle_resume_diff(self):
        try:
            res = subprocess.run(
                [sys.executable, str(AGENT_DIR / "src" / "agents" / "resume_fixer.py"), "--diff-only"],
                capture_output=True,
                text=True,
                cwd=str(AGENT_DIR),
                encoding="utf-8",
    ...
    def handle_resume_fix(self):
        ...
        try:
            ...
            proc = subprocess.Popen(
                [sys.executable, str(AGENT_DIR / "src" / "agents" / "resume_fixer.py")],
